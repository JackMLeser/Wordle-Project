...
//  Wordle
//
//  Created by Jack Leser on 9/3/23.
//
...
class ViewController: UIViewController {
    ...
    let answers =  ["after", "later", "bloke", "there", "ultra",  "happy", "nails", "party", "hoppy", "apple", "niggas", "updog", "boats", "funny", "scope", "sunny", "puppy",  "board"]
